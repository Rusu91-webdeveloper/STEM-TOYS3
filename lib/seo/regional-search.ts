...
export type RegionalStemCity = {
  ...
  city: string;
  county: string;
  /** Meta title — format: Jucarii STEM [Oras] | TechTots — Livrare 1–4 zile lucrătoare */
  title: string;
...
export const regionalStemCities: RegionalStemCity[] = [
  {
    ...
    title: "Jucarii STEM Bucuresti | TechTots — Livrare 1–4 zile lucrătoare",
    description:
      "Jucarii STEM Bucuresti cu livrare 1–4 zile lucrătoare. Selectie curata pe varste: robotica, experimente si constructii de la branduri premium europene. Alege rapid.",
    heroTitle:
      "Jucarii STEM Bucuresti — selectie curata pe varste, livrare 1–4 zile lucrătoare",
    heroDescription:
    ...
    deliveryInfo:
      "Comenzile catre Bucuresti sunt livrate prin curier, de obicei in 1–4 zile lucrătoare, in functie de momentul plasarii si de disponibilitatea stocului. Poti opta si pentru ridicare din punct Easybox acolo unde reteaua acopera zona ta, pentru flexibilitate dupa programul de la birou sau de la scoala.",
    proofPoints: [
    ...
    faq: [
      {
        ...
        answer:
          "In general, livrarea standard este in 1–4 zile lucrătoare. Livrarea in aceeasi zi nu este garantata; daca ai nevoie urgenta, verifica disponibilitatea si termenul comunicat la finalizarea comenzii sau contacteaza suportul inainte de plata.",
      },
      {
        question:
  ...
  },
  {
    ...
    city: "Cluj-Napoca",
    county: "Cluj",
    title: "Jucarii STEM Cluj-Napoca | TechTots — Livrare 1–4 zile lucrătoare",
    description:
      "Jucarii STEM Cluj-Napoca cu livrare 1–4 zile lucrătoare. Kituri de robotica, experimente si constructii cu selectie curata pe varste si branduri premium europene.",
    heroTitle:
      "Jucarii STEM Cluj-Napoca — selectie curata pe varste, livrare 1–4 zile lucrătoare",
    heroDescription:
    ...
    deliveryInfo:
      "Livram prin curier in Cluj-Napoca, cu estimare 1–4 zile lucrătoare. Easybox poate fi o varianta practica pentru studenti, parinti aflati intre campus, serviciu si activitatile copiilor, evitand cozi la ghiseu cand programul e incarcat.",
    proofPoints: [
    ...
    faq: [
      {
        ...
        answer:
          "Nu ne angajam la livrare in aceeasi zi; termenul tipic este 1–4 zile lucrătoare. Pentru urgente, confirma disponibilitatea produsului si termenul afisat la checkout.",
      },
      {
        question:
  ...
  },
  {
    ...
    city: "Timisoara",
    county: "Timis",
    title: "Jucarii STEM Timisoara | TechTots — Livrare 1–4 zile lucrătoare",
    description:
      "Jucarii STEM Timisoara cu livrare 1–4 zile lucrătoare. Robotica, experimente si seturi cu scop educativ clar. Selectie curata pe varste si branduri premium europene.",
    heroTitle:
      "Jucarii STEM Timisoara — selectie curata pe varste, livrare 1–4 zile lucrătoare",
    heroDescription:
    ...
    deliveryInfo:
      "Comenzile spre Timisoara ajung prin curier, de regula in 1–4 zile lucrătoare. Unde exista acoperire, Easybox poate fi aleasa pentru ridicare dupa program, util mai ales cand ai deplasari scurte intre cartiere sau cand nu e cineva acasa la intervalul curierului.",
    proofPoints: [
    ...
    faq: [
      {
        ...
        answer:
          "Livrarea standard este 1–4 zile lucrătoare. Livrarea in aceeasi zi nu este standard; verifica termenul din cos si mesajele de disponibilitate la finalizarea comenzii.",
      },
      {
        question:
  ...
  },
  {
    ...
    city: "Iasi",
    county: "Iasi",
    title: "Jucarii STEM Iasi | TechTots — Livrare 1–4 zile lucrătoare",
    description:
      "Jucarii STEM Iasi cu livrare 1–4 zile lucrătoare. Kituri educative, robotica si experimente cu selectie curata pe varste. Branduri premium europene, alegere usoara.",
    heroTitle:
      "Jucarii STEM Iasi — selectie curata pe varste, livrare 1–4 zile lucrătoare",
    heroDescription:
    ...
    deliveryInfo:
      "Livram in Iasi prin curier, cu estimare 1–4 zile lucrătoare. Ridicarea Easybox poate fi utila daca locuiesti in zone cu acces mai dificil la anumite intervale sau daca preferi sa nu depinzi de prezenta la usa in timpul zilei.",
    proofPoints: [
    ...
    faq: [
      {
        ...
        answer:
          "Nu garantam livrarea in aceeasi zi; in mod obisnuit livrarea este in 1–4 zile lucrătoare. Pentru termene stranse, verifica disponibilitatea produsului si mesajele din procesul de comanda.",
      },
      {
        question:
  ...
  },
  {
    ...
    city: "Constanta",
    county: "Constanta",
    title: "Jucarii STEM Constanta | TechTots — Livrare 1–4 zile lucrătoare",
    description:
      "Jucarii STEM Constanta cu livrare 1–4 zile lucrătoare. Robotica, experimente si constructii cu selectie curata pe varste. Branduri premium europene, livrare prin curier.",
    heroTitle:
      "Jucarii STEM Constanta — selectie curata pe varste, livrare 1–4 zile lucrătoare",
    heroDescription:
    ...
    deliveryInfo:
      "Livram prin curier catre Constanta, de obicei in 1–4 zile lucrătoare. In zone turistice sau in perioade aglomerate, Easybox poate fi o solutie stabila pentru ridicare cand intervalul curierului nu coincide cu prezenta acasa.",
    proofPoints: [
    ...
    faq: [
      {
        ...
        answer:
          "Livrarea in aceeasi zi nu este garantata; termenul tipic este 1–4 zile lucrătoare. In sezon sau in weekenduri aglomerate, confirma termenul afisat la finalizarea comenzii.",
      },
      {
        question:
...
export function getRegionalStemLinks(limit?: number): SearchRouteCard[] {
  const links = regionalStemCities.map(city => ({
    ...
    description: `Selectie curata de jucarii STEM in ${city.city} cu livrare 1–4 zile lucrătoare. Branduri premium europene, recomandate pe varste.`,
  }));
