      ...
      <div className="sticky top-14 sm:top-16 z-20 bg-white border-b border-gray-200 shadow-sm">
        <div className="container mx-auto px-2 sm:px-4 py-2 sm:py-4">
          ...
          <div className="flex items-center justify-center">
            <div className="flex gap-1.5 sm:gap-3 justify-center w-full max-w-5xl overflow-x-auto scrollbar-hide">
                ...
                .map(([key, category]) => {
                  ...
                  return (
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className={`flex-shrink-0 sm:flex-none h-10 sm:h-12 px-2 sm:px-5 rounded-full text-xs sm:text-sm font-bold flex items-center justify-center gap-1 sm:gap-2 border-2 transition-all hover:scale-105 shadow-sm ${
                    ...
                    >
                      ...
                      <span
                        className={`truncate ${key === "educational-books" ? "hidden xs:inline" : "xs:inline"}`}
                      >
                        {key === "mathematics"
                          ? "Math"
                          : key === "educational-books"
                            ...
                            : categoryLabel.length > 6
                              ? categoryLabel.substring(0, 6)
                              : categoryLabel}
                      </span>
                      <span className="xs:hidden text-[10px] font-extrabold tracking-tight">
                        {category.letter}
                      </span>
                    </Button>
                  );
