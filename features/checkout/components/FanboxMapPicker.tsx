      ...
      <div className="rounded-xl border border-slate-200 bg-white p-2 shadow-sm">
        <div className="mb-2 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="rounded-md border border-slate-200 bg-slate-50 px-2 py-1 text-xs text-slate-700 transition hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <div
          ...
          ref={rootNodeRef}
          className="h-[360px] overflow-hidden rounded-lg border border-slate-200 bg-slate-100"
        />
        ...
        {widgetError && (
          <p className="mt-2 text-xs text-amber-800">{widgetError}</p>
        )}
      </div>
          ...
          visibleList.map(point => {
            ...
            return (
              ...
              >
                ...
                {addressText && (
                  <p className="mt-0.5 text-xs text-slate-600">{addressText}</p>
                )}
              </button>
            );
          })
