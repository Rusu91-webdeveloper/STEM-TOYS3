...
import { ServerSideStripeForm } from "@/components/checkout/ServerSideStripeForm";
...
export function StripePaymentForm({
  ...
  // Show server-side Stripe form if client-side Stripe is not loaded or failed
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  Using server-side Stripe processing for enhanced security and reliability.
                </p>
              </div>
            </div>
          </div>
