  ...
  describe("Boribon UPSELL Safety", () => {
    it("skips uninstalled UPSELL entries without throwing", async () => {
      ...
      fetchBoribonProducts.mockResolvedValue([
        {
          ...
          row: { id: "8397", model: "G_7449", sku: "4716503074498", price_b2c: "191", quantity: "52" },
          price: 191,
          stock: 52,
          valid: true,
          error: null,
        },
        {
          ...
          row: { id: "4409", model: "K_550205", sku: "814743017900", price_b2c: "103", quantity: "6" },
          price: 103,
          stock: 6,
          valid: true,
          error: null,
      ...
      expect(consoleWarnSpy).toHaveBeenCalledWith(
        expect.stringContaining("[Boribon sync] Skipping uninstalled UPSELL: K_550205")
      );
    ...
    it("skips invalid UPSELL entries without closing stock", async () => {
      fetchBoribonProducts.mockResolvedValue([
        ...
        {
          entry: { model: "K_550205", ean: "814743017900", tier: "UPSELL" },
          row: { id: "4409", model: "K_550205", sku: "814743017900", price_b2c: "0", quantity: "0" },
          price: null,
          stock: 0,
          valid: false,
  ...
  describe("Kidstory UPSELL Safety", () => {
    it("skips uninstalled UPSELL entries without throwing", async () => {
      fetchKidstoryProducts.mockResolvedValue([
        {
          entry: { sourceId: "24630", sku: "F4541ML", ean: "810074274432", role: "HERO" },
          row: {
            id: "24630",
            sku: "F4541ML",
            ean: "810074274432",
        ...
        {
          entry: { sourceId: "28478", sku: "F5601ML", ean: "810074278355", role: "UPSELL" },
          row: {
            id: "28478",
            sku: "F5601ML",
            ean: "810074278355",
      ...
      expect(result.failed).toBe(0); // UPSELL skipped, not failed
      expect(consoleWarnSpy).toHaveBeenCalledWith(
        expect.stringContaining("[Kidstory sync] Skipping uninstalled UPSELL: F5601ML")
      );
