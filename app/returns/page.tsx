...
const legalItems = [
  ...
  "Directiva UE 2019/771 privind contractele de vânzare a bunurilor",
  "Legea română nr. 449/2003 privind vânzarea de bunuri de consum",
          ...
          <div className="mx-auto max-w-5xl space-y-8 sm:space-y-10">
            ...
            <section className="rounded-3xl border border-white/10 bg-white/5 p-5 shadow-lg shadow-black/30 backdrop-blur sm:p-7 md:p-9">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none text-slate-200">
                <p className="leading-relaxed">
                  ...
                  fără a fi necesar să oferi o justificare.
                </p>
              </div>
              ...
              <div className="my-5 rounded-2xl border border-white/10 bg-slate-900/60 p-4 sm:my-6 sm:p-5 md:my-7 md:p-6">
                ...
                <div className="rounded-2xl border border-sky-500/20 bg-sky-500/10 p-4">
                  ...
                  <ol className="ml-3 list-decimal space-y-1.5 text-xs text-slate-100 sm:ml-5 sm:space-y-2 sm:text-sm">
                    ...
                    <li>Predă pachetul la punctul de colectare indicat în email</li>
                  </ol>
                </div>
              </div>
              <div>
            ...
            <section className="rounded-3xl border border-white/10 bg-white/5 p-5 shadow-lg shadow-black/30 backdrop-blur sm:p-7 md:p-9">
              ...
              <div className="mt-6 rounded-2xl border border-amber-400/30 bg-amber-500/10 p-4 text-xs text-amber-100 shadow-inner shadow-amber-500/20 sm:mt-7 sm:p-5 sm:text-sm">
                ...
                <ul className="mt-3 space-y-2 text-amber-100/90">
                  ...
                  <li>
                    • <strong>Eroare din partea noastră:</strong> Transport gratuit și rambursare completă
                  </li>
                  <li>
                    • <strong>Eticheta de returnare:</strong> Vei primi automat prin email - nu este nevoie să printezi nimic în avans
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="overflow-hidden rounded-3xl border border-sky-500/40 bg-gradient-to-br from-sky-500/20 via-indigo-900/40 to-slate-950/80 p-5 text-slate-100 shadow-xl shadow-sky-500/30 sm:p-7 md:p-9">
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-2 md:gap-6">
                <div>
                  <h3 className="text-sm font-semibold text-white sm:text-base md:text-lg">📞 Contactează Echipa Noastră</h3>
                  <div className="mt-3 space-y-2 text-xs text-slate-100 sm:text-sm">
                    ...
                    <p>💬 Chat Live: Disponibil pe site în timpul programului</p>
                  </div>
                </div>
                <div>
                  <h3 className="text-sm font-semibold text-white sm:text-base md:text-lg">📍 Adresa pentru Returnări</h3>
                  <div className="mt-3 rounded-2xl border border-white/10 bg-white/10 p-4 text-xs text-slate-100 sm:text-sm">
                    ...
                    <p className="mt-3 text-xs text-slate-200">
                      <strong className="text-white">Nu trimite produse la această adresă fără să ne contactezi mai întâi!</strong>
                    </p>
                  </div>
                </div>
              </div>
