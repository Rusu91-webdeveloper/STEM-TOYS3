            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                        Livrăm rapid în toată România cu parteneri de încredere.
                        Primești coletul în 5-10 zile lucrătoare.
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-10 shadow-sm">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-blue-800">
                        ...
                        <li className="flex items-center gap-2">
                            <span className="text-green-600">✓</span>
                            Cost livrare: {formatPrice(onlinePaymentPrice)} RON (online) / {formatPrice(rambursPrice)} RON (ramburs)
                        </li>
                        {isFreeShippingActive && (
                            <li className="flex items-center gap-2">
                                <span className="text-green-600">✓</span>
                                Livrare GRATUITĂ pentru comenzi peste {formatPrice(freeThreshold)} RON
                            </li>
                        )}
                        <li className="flex items-center gap-2">
                            <span className="text-green-600">✓</span>
                                    ...
                                    <tr className="bg-green-50 hover:bg-green-100 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="font-medium">Comenzi peste {formatPrice(freeThreshold)} RON</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 font-bold text-green-600 text-right text-lg">
                                            GRATUIT
                ...
                <section className="mb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white rounded-xl p-6 shadow-md border border-slate-200">
                            ...
                            <h3 className="font-semibold text-slate-900 mb-2">București și orașe mari</h3>
                            <p className="text-slate-600 text-sm">3-5 zile lucrătoare</p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-md border border-slate-200">
                            <div className="text-3xl mb-3">🗺️</div>
                            <h3 className="font-semibold text-slate-900 mb-2">Restul țării</h3>
                            <p className="text-slate-600 text-sm">5-7 zile lucrătoare</p>
                        </div>
                        <div className="bg-white rounded-xl p-6 shadow-md border border-slate-200">
                            <div className="text-3xl mb-3">🏔️</div>
                            <h3 className="font-semibold text-slate-900 mb-2">Zone îndepărtate</h3>
                            <p className="text-slate-600 text-sm">7-10 zile lucrătoare</p>
                        </div>
                    </div>
                    <p className="text-sm text-slate-500 mt-4">
                        * Comenzile plasate până la ora 14:00 în zilele lucrătoare sunt procesate în aceeași zi.
                        Timpul de livrare depinde și de procesarea de către furnizor.
                    </p>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
                        <p className="text-slate-700 mb-4">
                            Pentru comenzile cu plată ramburs se aplică un cost suplimentar de procesare
                            care acoperă serviciile de încasare ale curierului și transferul bancar.
                        </p>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-slate-200">
                        <p className="text-slate-700 mb-4">
                            Toate coletele cu o valoare de peste 500 RON beneficiază automat de asigurare
                            la valoarea integrală a comenzii. Acoperă:
                        </p>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                        <p className="text-amber-800">
                            Pentru localități în afara zonelor standard de livrare pot exista termene extinse.
                            În aceste cazuri, vă contactăm înainte de expediere pentru a confirma detaliile.
                        </p>
                    </div>
                </section>
                ...
                <section className="mb-10">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-md border border-slate-200">
                        <p className="text-slate-700 mb-4">
                            Conform <strong>Directivei UE 2011/83/EU</strong>, aveți dreptul de retragere
                            în termen de 14 zile de la primirea produselor.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                                <p className="font-semibold text-green-800">Comenzi peste {formatPrice(freeThreshold)} RON</p>
                                <p className="text-green-700 text-sm">Returnare gratuită cu etichetă preplătită</p>
                            </div>
                            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                                <p className="font-semibold text-slate-800">Comenzi sub {formatPrice(freeThreshold)} RON</p>
                                <p className="text-slate-600 text-sm">Costul returului suportat de client</p>
                            </div>
                        </div>
                        <Link
                            href="/returns"
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600">
                                    Livrare la domiciliu în toată România cu urmărire în timp real.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        <details className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 group">
                            ...
                            <p className="mt-4 text-slate-600">
                                Livrarea durează de obicei 5-10 zile lucrătoare de la confirmarea comenzii.
                                Timpul exact depinde de procesarea de către furnizor și de zona de livrare.
                            </p>
                        </details>
                        <details className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 group">
                            <summary className="font-semibold text-slate-900 cursor-pointer list-none flex items-center justify-between">
                            ...
                            <p className="mt-4 text-slate-600">
                                După expediere primești un email cu link-ul de urmărire FanCourier.
                                Poți verifica statusul și reprograma livrarea direct din portalul curierului.
                            </p>
                        </details>
                        <details className="bg-white rounded-xl p-6 shadow-sm border border-slate-200 group">
                            <summary className="font-semibold text-slate-900 cursor-pointer list-none flex items-center justify-between">
                            ...
                            <p className="mt-4 text-slate-600">
                                Curierul te va contacta telefonic. Poți solicita redirecționarea coletului sau
                                o nouă zi de livrare. Echipa de suport te poate ajuta pentru a găsi soluția preferată.
                            </p>
                        </details>
                    </div>
                </section>
                ...
                <section className="mt-10 text-sm text-slate-500">
                    <h3 className="font-semibold text-slate-700 mb-2">Conformitate Legală</h3>
                    <p>
                        Această politică respectă Directiva UE 2011/83/EU, Directiva UE 2019/771,
                        OG 130/2000 și Legea nr. 449/2003.
                    </p>
                    <p className="mt-4">
                        Ultima actualizare: {new Intl.DateTimeFormat("ro-RO", {
                            day: "numeric",
                            month: "long",
                            year: "numeric",
                        }).format(new Date())}
