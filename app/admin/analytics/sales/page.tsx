...
export default async function SalesAnalyticsPage() {
  ...
  try {
    ...
    const cacheKey = CacheKeys.analytics(`sales-page:${defaultPeriod}`);
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <p className="text-muted-foreground">
            Revenue, orders, and business performance metrics
          </p>
        </div>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="text-center py-8">
          <p className="text-muted-foreground">
            Sales analytics data is temporarily unavailable. Please try
            refreshing the page.
          </p>
        </div>
      </div>
