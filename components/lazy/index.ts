...
import { createAsyncComponent, createIntersectionLazyComponent } from "@/lib/bundle-analyzer";
...
const SkeletonLoading: ComponentType<{ className?: string }> = ({ className = "" }) => 
  React.createElement('div', {
...
export const LazyPaymentForm = createAsyncComponent(
  () => import("@/features/checkout/components/PaymentForm"),
  "PaymentForm",
  { loading: DefaultLoading }
);
...
export const LazyProductReviews = createIntersectionLazyComponent(
  () => import("@/features/products/components/ProductReviews"),
  "ProductReviews",
  { rootMargin: "100px" }
);
...
export const LazyRelatedProducts = createIntersectionLazyComponent(
  () => import("@/features/products/components/RelatedProducts"),
  "RelatedProducts",
  { rootMargin: "100px" }
);
...
export const LazyProductComparison = createAsyncComponent(
  () => import("@/features/products/components/ProductComparison"),
  "ProductComparison",
  { loading: DefaultLoading }
);
...
export const LazyCartSummary = createAsyncComponent(
  () => import("@/features/cart/components/CartSummary"),
  "CartSummary",
  { loading: DefaultLoading }
);
...
export const LazyImageGallery = createAsyncComponent(
  ...
  "ImageGallery",
  { 
    loading: () => React.createElement(SkeletonLoading, { className: "w-full h-96" })
  }
);
...
export const LazyVideoPlayer = createAsyncComponent(
  ...
  "VideoPlayer",
  { 
    loading: () => React.createElement(SkeletonLoading, { className: "w-full h-64" })
  }
);
...
export const LazyInventoryManagement = createAsyncComponent(
  () => import("@/app/admin/products/components/InventoryManagement"),
  "InventoryManagement",
  { loading: DefaultLoading }
);

export const LazyReportsPage = createAsyncComponent(
  () => import("@/app/admin/analytics/components/ReportsPage"),
  "ReportsPage",
  { loading: DefaultLoading }
);
