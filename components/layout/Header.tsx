                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      {t("mobileMenuSubtitle", "Navigație rapidă pentru cumpărături")}
                    </p>
                  </div>
                </div>
                      ...
                      <span className="flex items-center gap-3">
                        ...
                        <span>
                          ...
                          <span className="block text-xs text-slate-500">
                            {activeFilters.hasActiveFilters
                              ? t("activeFiltersLabel", "Filtre active pentru browsing rapid")
                              : t("browseProductsLabel", "Descoperă colecții, vârste și categorii")}
                          </span>
                        </span>
                      </span>
                    ...
                    {productsMenuOpen && (
                      ...
                      >
                        ...
                        <div className="rounded-[1rem] border border-slate-200 bg-white">
                          ...
                          {ageOpen && (
                            <div id="mobile-age-subsection" className="space-y-1 border-t border-slate-100 px-2 pb-2 pt-1">
                              {[
                                { id: "TODDLERS_1_3", label: t("age0to3", "0–3 ani"), color: "bg-amber-400" },
                                { id: "PRESCHOOL_3_5", label: t("age3to5", "4–6 ani"), color: "bg-emerald-400" },
                                { id: "ELEMENTARY_6_8", label: t("age6to8", "7–9 ani"), color: "bg-sky-400" },
                                { id: "MIDDLE_SCHOOL_9_12", label: t("age9to12", "10–12 ani"), color: "bg-violet-400" },
                                { id: "TEENS_13_PLUS", label: t("age13plus", "13+ ani"), color: "bg-rose-400" },
                              ].map(opt => (
                                <button
                                  key={opt.id}
                                  type="button"
                        ...
                        <div className="rounded-[1rem] border border-slate-200 bg-white">
                          ...
                          {categoryOpen && (
                            <div id="mobile-category-subsection" className="space-y-1 border-t border-slate-100 px-2 pb-2 pt-1">
                              {categories.map(cat => (
                                <button
                                  key={cat.id}
                                  type="button"
                      ...
                      <div className="space-y-2">
                          ...
                          >
                            ...
                            <span className="flex-1">
                              ...
                              <span className="block text-xs text-violet-700/75">
                                {t("adminShortcutLabel", "Administrare și operațiuni")}
                              </span>
                            </span>
                        ...
                        {(session?.user?.role === "VISITOR" ||
                          ...
                          >
                            ...
                            <span className="flex-1">
                              <span className="block text-sm font-semibold">Database Schema</span>
                              <span className="block text-xs text-sky-700/75">
                                {t("databaseShortcutLabel", "Arhitectura și structura datelor")}
                              </span>
                            </span>
                        ...
                        {isSupplier && (
                          ...
                          >
                            ...
                            <span className="flex-1">
                              <span className="block text-sm font-semibold">{t("supplier")}</span>
                              <span className="block text-xs text-emerald-700/75">
                                {t("supplierShortcutLabel", "Portal furnizori și comenzi")}
                              </span>
                            </span>
                      ...
                      {shouldShowAuthenticatedUI ? (
                        <>
                          ...
                          >
                            ...
                            <span className="flex-1">
                              <span className="block font-semibold">{t("account")}</span>
                              <span className="block text-xs text-slate-500">
                                {t("accountOverviewLabel", "Comenzi, profil și preferințe")}
                              </span>
                            </span>
                            <span className="text-slate-400">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <span className="flex-1">
                              ...
                              <span className="block text-xs text-slate-500">
                                {wishlistCount > 0
                                  ...
                                  : t("wishlistEmptyState", "Salvează produse pentru mai târziu")}
                              </span>
                            </span>
                            <span className="text-slate-400">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          >
                            ...
                            <span className="flex-1">
                              <span className="block font-semibold">{t("logout")}</span>
                        ...
                        <>
                          ...
                          >
                            ...
                            <span className="flex-1">
                              <span className="block font-semibold">{t("login", "Autentificare")}</span>
                              <span className="block text-xs text-slate-500">
                                {t("loginShortcutLabel", "Intră în cont pentru comenzi și favorite")}
                              </span>
                            </span>
                            <span className="text-slate-400">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          >
                            ...
                            <span className="flex-1">
                              <span className="block font-semibold">{t("wishlist", "Favorite")}</span>
                              <span className="block text-xs text-slate-500">
                                {t("wishlistGuestLabel", "Păstrează produsele preferate aproape")}
                              </span>
                            </span>
                          </button>
                        </>
